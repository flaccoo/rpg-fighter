...
class Character:
    ...
    def generate_weapon(self):
        ...
        elif random_weapon == 96: self.weapon = Weapon("Master Sword", 50)
        elif random_weapon == 97: self.weapon = Weapon("Excalibur", 15)
        elif random_weapon == 98: self.weapon = Weapon("Diamon Axe", 10)
        elif random_weapon == 99: self.weapon = Weapon("Koriki Sword", 30)
        elif random_weapon == 100: self.weapon = Weapon("Netherite Sword", 20)
